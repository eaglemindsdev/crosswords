<template>
    <section class="p-3 lg:my-2 border dark:border-gray-800 rounded-md min-w-[200px] dark:bg-slate-900" data-location="SearchBox">
        ...
        <h2 class="mb-5 text-xl leading-7 dark:text-zinc-300  lg:block">Search Crossword Answers</h2>
        <form action="">
          ...
          <button type="submit" class="mt-6 px-6 py-3.5 w-full text-base font-bold text-white bg-purple-500 hover:bg-denim-blue rounded transition-colors">Find Answer</button>
        </form>
